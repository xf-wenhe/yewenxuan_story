...
const QQ1 = '嗓音降了下来。。';
const QQ2 = '嗓音开口。。';
const QQ3 = '嗓音像砂砾摩擦，干涩难听。，';
const QQ4 = '嗓音里带着粗糙的沙粒感。，';
const QQ5 = '嗓音沙哑到了极限。，';
const QQ6 = '嗓音干涩而粗糙。，';
const QQ7 = '嗓音里满是粗糙的沙砾感。，';
const QQ8 = '声调忽然变低。。';
...
const REPL = [
  [QQ1, Qq[0], Qq[1], Qq[2], Qq[3]],
  [QQ2, Qq[4], Qq[5], Qq[6], Qq[7]],
  [QQ3, Qq[8], Qq[9], Qq[10], Qq[11]],
  [QQ4, Qq[12], Qq[13], Qq[14], Qq[15]],
  [QQ5, Qq[16], Qq[17], Qq[18], Qq[19]],
  [QQ6, Qq[20], Qq[21], Qq[22], Qq[23]],
  [QQ7, Qq[24], Qq[25], Qq[26], Qq[27]],
  [QQ8, Qq[28], Qq[29], Qq[30], Qq[31]],
];
