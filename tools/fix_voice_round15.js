...
const CLEAN_PAD = ["房间里很安静，只能听到他自己的心跳声。","他的身体僵住了，一动也不敢动。","空气中弥漫着一股若有若无的气息。","他站在那里，周围的一切仿佛都凝固了。","他低下头，看着自己的双手，心里沉甸甸的。"];

const REPL = [
  ["没有任何表情","毫无表情","没有半分表情","面无表情"],
  ["嘴角动了动","嘴角微微抽动","嘴角扯了扯","嘴角牵动了一下","嘴角轻轻动了动"],
  ["呼吸猛地","呼吸忽然","呼吸陡然","呼吸骤然","呼吸猛然"],
  ["眼底深处","眼底更深处","眼底更深的地方","眼底最深处"],
  ["脸上出现","脸上泛起","脸上浮现","脸上绽出","脸上现出"],
  ["脸上露出","脸上浮现","脸上泛起","脸上绽出","脸上现出"],
  ["情不自禁","不由自主","下意识地","不由地","忍不住"],
  ["目光变得","目光渐渐","目光愈显","目光慢慢变得"],
];
