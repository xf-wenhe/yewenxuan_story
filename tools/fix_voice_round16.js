...
const REPL = [
  ["心脏猛地","心脏骤然","心脏陡然","心脏忽然","心脏猛然","心脏渐渐","心脏慢慢"],
  ["猛地一跳","骤然一跳","陡然一跳","忽然一跳","猛然一跳","瞬间一跳","猛地一颤","猛地一僵","猛地一震"],
  ["猛地一沉","骤然一沉","陡然一沉","忽然一沉","猛然一沉","猛地一缩"],
  ["喉咙动了","他清了清喉","喉间动了动","喉头动了动","喉间滚了滚","他清了清喉咙","他清了清喉间"],
  ["面无表情","没有半分表情","脸上没有表情","脸上表情不变","脸上神情不变","脸上神色不变"],
];
