...
// === R69 SOURCES (8 叶文轩.*声音. patterns) ===

const GG1 = '叶文轩的声音平稳而毫无波澜。';
const GG2 = '叶文轩说话时声音轻得听不见。';
const GG3 = '叶文轩的声音平淡得像一条直线。';
const GG4 = '叶文轩的声音平直没有任何波澜。';
const GG5 = '叶文轩说话的声音冷得没有半分温度。';
const GG6 = '叶文轩的声音平静而平淡。';
const GG7 = '叶文轩将声音压到了最低处。';
const GG8 = '叶文轩的声音有些平。';

const VOLUMES = ['volume-1','volume-2','volume-3','volume-4','volume-5','volume-6','volume-7'];
const TARGET = 3020;// === R69 ALTERNATIVES (8 sources × 4 = 32 total) ===
...
const REPL = [
  [GG1, Gh[0], Gh[1], Gh[2], Gh[3]],
  [GG2, Gh[4], Gh[5], Gh[6], Gh[7]],
  [GG3, Gh[8], Gh[9], Gh[10], Gh[11]],
  [GG4, Gh[12], Gh[13], Gh[14], Gh[15]],
  [GG5, Gh[16], Gh[17], Gh[18], Gh[19]],
  [GG6, Gh[20], Gh[21], Gh[22], Gh[23]],
  [GG7, Gh[24], Gh[25], Gh[26], Gh[27]],
  [GG8, Gh[28], Gh[29], Gh[30], Gh[31]],
];
