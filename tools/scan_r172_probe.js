...
const candidates = [
  '嗓音喑哑', '嗓音喑然', '嗓音喑沉', '嗓音喑喑', '嗓音喑暗',
  '声调无波', '声调低平', '声调未改', '声调平缓',
  '目光锁住', '目光钉住', '视线锁定', '视线锁住',
  '语气无波', '语气冷淡', '语气无温', '语气冷然', '语气漠然', '语气寡淡',
  '语气不变', '语气未变', '语气未改', '语气低平', '语气平淡',
  '语调平淡', '语调平白',
  '视线定住', '视线凝定', '视线凝持', '视线凝望', '视线凝望',
  '目光投向', '目光挪开', '目光停住', '目光移去', '目光投过',
  '目光扫向', '目光望过', '目光瞥向', '目光投向',
  '嗓音低沉', '嗓音发暗', '嗓音低回', '嗓音沙哑', '嗓音暗哑', '嗓音低哑', '嗓音发寒', '嗓音发哑', '嗓音发涩', '嗓音发粗',
  '声调平淡', '声调平白', '声调寡淡', '声调不变', '声调之外', '声调之内', '声调之间',
